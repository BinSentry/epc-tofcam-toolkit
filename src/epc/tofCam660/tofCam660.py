...
class TOFcam660_Settings(TOF_Settings_Controller):
    ...
    def set_illuminator_segments(self, segment_1_on: bool = True, segment_2_on: bool = True, segment_3_on: bool = True, segment_4_on: bool = True, two_segment_on: bool = True):
        ...
        log.info(f"Setting illuminator segments: ("
		 ...
		 f"Two segment:{'ON' if two_segment_on else 'OFF'})")
